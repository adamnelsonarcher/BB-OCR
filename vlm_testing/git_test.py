...
def run_inference(image_path, prompts):
    ...
    model_name = "microsoft/git-large-coco"  # Using the larger model trained on COCO
...
def main():
    parser = argparse.ArgumentParser(description="GIT test for VLM on a single image")
