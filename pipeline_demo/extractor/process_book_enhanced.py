...
METADATA_SCHEMA = {
    ...
    "properties": {
        ...
        "price": {"type": "object", "properties": {"currency": {"type": ["string", "null"]}, "amount": {"type": ["number", "null"]}}}
    }
}
...
def main():
    ...
    parser.add_argument("--output-dir", "-o", type=str, default="output", help="Directory to save output JSON (default: output)")
    ...
    parser.add_argument("--no-raw", action="store_true", help="Don't show processing information")
    ...
    success = process_book_enhanced(
        args.book_id, args.output_dir, args.model, args.ocr_engine, not args.no_preprocessing,
        args.ocr_indices, not args.no_raw, args.books_dir, args.crop_ocr, args.crop_margin,
        args.no_warm_model, None, args.edge_crop
    )
