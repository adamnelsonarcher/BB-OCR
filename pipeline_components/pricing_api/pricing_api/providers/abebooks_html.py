...
class AbeBooksHtmlProvider:
    ...
    async def lookup(
        ...
        *,
        ...
        # Build keyword query from title + primary author + year
        ...
        # AbeBooks has varied markup; try several common patterns
        ...
        for c in cards:
            try:
                ...
                # normalize price amount and currency
                amount = None
                currency = None
                if price_text:
        ...
        # Return top N by score descending (limit 10)
